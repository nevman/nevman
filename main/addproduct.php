...
<span>Container : </span><input type="int" style="width:265px; height:30px;" name="cont" ><br>
<span>Similar Product: </span><input type="int" style="width:265px; height:30px;" name="s_product" ><br>
...
<span>Price out: </span><input type="text" id="txt1" style="width:265px; height:30px;" name="price" onkeyup="sum();" Required><br>
<span>Price In: </span><input type="text" id="txt2" style="width:265px; height:30px;" name="o_price" onkeyup="sum();" Required><br>
