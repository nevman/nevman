...
<table class="hoverTable" id="resultTable" data-responsive="table" style="text-align: left; color: red;">
	<thead>
		<tr>
	...
	<tbody>
		<style>
			td {background-color: rgb(189, 11, 11)}
			td {color: white;}
		</style>
			...
			<td><a rel="facebox" title="Click to edit the product" href="editproductcashier.php?id=<?php echo $row['product_id']; ?>"><button class="btn btn-warning"><i class="icon-edit"></i> </button> </a>
