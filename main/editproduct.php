...
<span>Category : </span><textarea style="width:265px; height: 30px;" name="name" ><?php echo $row['product_name']; ?> </textarea><br>
<span>Container : </span><input type="number" style="width:265px; height:30px;"  name="cont" value="<?php echo $row['container']; ?>" /><br>
<span>Similar Product: </span><input type="text" style="width:265px; height:30px;"  name="s_product" value="<?php echo $row['s_product']; ?>" /><br>
...
<span>Price Out: </span><input type="text" style="width:265px; height:30px;" id="txt1" name="price" value="<?php echo $row['price']; ?>" onkeyup="sum();" Required/><br>
<span>Price In: </span><input type="text" style="width:265px; height:30px;" id="txt2" name="o_price" value="<?php echo $row['o_price']; ?>" onkeyup="sum();" Required/><br>
